...
const bindings: Bindings = require('../lib/binding/napi-v3/bcrypt_lib.node');
 ...
 * @returns salt
 */
export function genSaltSync(rounds: number = 10, minor: Minor = 'b'): string {
 ...
 */
export function hashSync(data: HashData, salt: Salt): string {	
 ...
 */
export function compareSync(data: HashData, hash: string): boolean {
